...
class TestCalculateTotalInches(unittest.TestCase):
    ...
    def test_negative_feet(self):
        self.assertRaises(ValueError, calculate_total_inches, -5, 9)

    def test_negative_inches(self):
        self.assertRaises(ValueError, calculate_total_inches, 5, -7)

    def test_negative_inputs(self):
        self.assertRaises(ValueError, calculate_total_inches, -5, -10)
